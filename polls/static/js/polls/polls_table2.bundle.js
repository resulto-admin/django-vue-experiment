...
/***/ function(module, exports, __webpack_require__) {
	...
	var VueTables = __webpack_require__(10);
	var cellName = __webpack_require__(104);
...
/***/ function(module, exports, __webpack_require__) {
	...
	String.prototype.ucfirst = __webpack_require__(11);
	Array.prototype.diff = __webpack_require__(12);

	exports.client = __webpack_require__(13);
	exports.server = __webpack_require__(98);
...
/***/ function(module, exports) {
	...
	module.exports = function (a) {
	    return this.filter ? this.filter(function (i) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var computed = __webpack_require__(46);
	var data = __webpack_require__(53);
	var created = __webpack_require__(54);
	var directives = __webpack_require__(56);
	var watchers = __webpack_require__(59);
	var template = __webpack_require__(60);
	var VuePagination = __webpack_require__(76);
	...
	exports.install = function (Vue, globalOptions) {
	  ...
	  var client = {
	    ...
	    created: function created() {
	      ...
	      if (this.opts.compileTemplates) this.setClientWatchers();
	    ...
	    computed: {
	      q: __webpack_require__(81),
	      customQ: __webpack_require__(82),
	      totalPages: __webpack_require__(83),
	      filteredData: __webpack_require__(84)
	    },

	    filters: {
	      setCount: __webpack_require__(93),
	      date: __webpack_require__(94)
	    },

	    methods: {
	      transformDateStringsToMoment: __webpack_require__(95),
	      registerClientFilters: __webpack_require__(96),
	      initClientFilters: __webpack_require__(97),
	      search: __webpack_require__(90)
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    methods: (_methods = {
	        initQuery: __webpack_require__(16),
	        initOptions: __webpack_require__(17),
	        sortableClass: __webpack_require__(20),
	        sortableChevronClass: __webpack_require__(21),
	        display: __webpack_require__(22),
	        orderByColumn: __webpack_require__(23),
	        getHeading: __webpack_require__(25),
	        addCustomColumns: __webpack_require__(26),
	        sortable: __webpack_require__(27)
	    }, _defineProperty(_methods, 'display', __webpack_require__(22)), _defineProperty(_methods, 'serverSearch', __webpack_require__(28)), _defineProperty(_methods, 'initOrderBy', __webpack_require__(29)), _defineProperty(_methods, 'initDateFilters', __webpack_require__(30)), _defineProperty(_methods, 'setPage', __webpack_require__(31)), _defineProperty(_methods, 'initPagination', __webpack_require__(32)), _defineProperty(_methods, 'filterable', __webpack_require__(33)), _defineProperty(_methods, 'isTextFilter', __webpack_require__(34)), _defineProperty(_methods, 'isDateFilter', __webpack_require__(35)), _defineProperty(_methods, 'isListFilter', __webpack_require__(36)), _defineProperty(_methods, 'highlightMatch', __webpack_require__(37)), _defineProperty(_methods, 'formatDate', __webpack_require__(38)), _defineProperty(_methods, 'hasDateFilters', __webpack_require__(40)), _defineProperty(_methods, 'applyFilters', __webpack_require__(42)), _defineProperty(_methods, 'optionText', __webpack_require__(43)), _defineProperty(_methods, 'render', __webpack_require__(44)), _defineProperty(_methods, 'rowWasClicked', __webpack_require__(45)), _methods)
	};
...
/***/ function(module, exports) {
	...
	module.exports = function (text, value) {
	   ...
	   if (text && value) text = text.replace(/{.+}/, value);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var bus = __webpack_require__(24);
...
/***/ function(module, exports) {
	...
	module.exports = function (value) {
	    return this.opts.headings.hasOwnProperty(value) ? this.opts.headings[value] : value.split("_").join(" ").ucfirst();
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function () {
	  ...
	  var search = function search() {
	    return that.source == 'client' ? that.search(that.data) : that.serverSearch();
	  };
...
/***/ function(module, exports) {
	...
	module.exports = function (column) {
	  ...
	  return this.customColumns.indexOf(column) == -1 && (typeof this.opts.filterable == 'boolean' && this.opts.filterable || this.opts.filterable.indexOf(column) > -1);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var validMoment = __webpack_require__(39);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var intersection = __webpack_require__(41);
...
/***/ function(module, exports) {
	...
	module.exports = function (row, column, h) {
	  ...
	  return h(
	    ...
	    [template.apply(this.$parent, [h, row])]
	  );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  computed: {
	    listColumnsObject: __webpack_require__(47),
	    allColumns: __webpack_require__(48),
	    customColumns: __webpack_require__(49),
	    templatesKeys: __webpack_require__(50),
	    opts: __webpack_require__(51)
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var is_empty = __webpack_require__(55);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (source) {
	  return function (h) {
	    ...
	    var rows = __webpack_require__(61)(h, this);
	    var normalFilter = __webpack_require__(62)(h, this);
	    var dropdownPagination = __webpack_require__(63)(h, this);
	    var columnFilters = __webpack_require__(64)(h, this);
	    var footerHeadings = __webpack_require__(68)(h, this);
	    var noResults = __webpack_require__(69)(h, this);
	    var pagination = __webpack_require__(70)(h, this);
	    var dropdownPaginationCount = __webpack_require__(71)(h, this);
	    var headings = __webpack_require__(72)(h, this);
	    var perPage = __webpack_require__(74)(h, this);
	        ...
	        return h(
	            ...
	            [h(
	                ...
	                { "class": "form-control",
	                    ...
	                    on: {
	                        change: that.setPage.bind(that, null, null)
	                    }
	                },
	                [pages]
	            )]
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (h, that) {
	  ...
	  var textFilter = __webpack_require__(65)(h, that);
	  var dateFilter = __webpack_require__(66)(h, that);
	  var listFilter = __webpack_require__(67)(h, that);
	  ...
	  return function (column) {
	    return h(
	      ...
	      [h(
	        ...
	        [that.display('filterBy', that.getHeading(column))]
	      )]
	    );
	  };
	};
	    ...
	    return h(
	      ...
	      [h(
	        ...
	        [h(
	          ...
	          [that.display('defaultOption', that.getHeading(column))]
	        ), options]
	      )]
	    );
	  };
...
/***/ function(module, exports) {
	...
	module.exports = function (h, that) {
	    if (that.count == 0) return h(
	        "tr",
	        { "class": "VueTables__no-results" },
	        [h(
	            "td",
	            { "class": "text-center",
	                attrs: { colspan: that.allColumns.length }
	            },
...
/***/ function(module, exports) {
	...
	module.exports = function (h, that) {
	  if (that.opts.pagination && !that.opts.pagination.dropdown) return h(
	    "pagination",
	    {
	      ref: "pagination",
	      attrs: { "for": that.id,
...
/***/ function(module, exports) {
	...
	module.exports = function (h, that) {
	  if (that.count > 0 && that.opts.pagination.dropdown) return h(
	    "div",
	    { "class": "VuePagination" },
	    [h(
	      "p",
	      { "class": "VuePagination__count" },
	      [that.display('count', that.count)]
	    )]
	  );
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (h, that) {
	  ...
	  var sortControl = __webpack_require__(73)(h, that);
...
/***/ function(module, exports) {
	...
	module.exports = function (h, that) {
	  return function (column) {
	    ...
	    return h(
	      "span",
	      _defineProperty({ "class": "VueTables__sort-icon pull-right"
	      }, "class", that.sortableChevronClass(column)),
	      []
	    );
	  }.bind(that);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (h, that) {
	  ...
	  var perpageValues = __webpack_require__(75)(h, that);
	  ...
	  return h(
	    ...
	    [h(
	      ...
	      { 'class': 'form-control',
	        ...
	        on: {
	          change: that.setPage.bind(that, 1, true)
	        }
	      },
	      [perpageValues]
	    )]
...
/***/ function(module, exports, __webpack_require__) {
	...
	var merge = __webpack_require__(18);
	var busState = __webpack_require__(79);
	var vuexState = __webpack_require__(80);
	...
	module.exports = function () {
	  return function (h) {
	    ...
	    this.pages.map(function (page) {
	      items.push(h(
	        "li",
	        _defineProperty({ "class": "VuePagination__pagination-item"
	    ...
	    return h(
	      ...
	      [h(
	        ...
	        [h(
	          "li",
	          _defineProperty({ "class": "VuePagination__pagination-item VuePagination__pagination-item-prev-chunk"
	          ...
	          "li",
	          _defineProperty({ "class": "VuePagination__pagination-item VuePagination__pagination-item-prev-page"
	          ...
	          "li",
	          _defineProperty({ "class": "VuePagination__pagination-item VuePagination__pagination-item-next-page"
	          }, "class", this.allowedPageClass(this.page + 1)),
	          [h(
	            "a",
	            {
	          ...
	          "li",
	          _defineProperty({ "class": "VuePagination__pagination-item VuePagination__pagination-item-next-chunk"
	          }, "class", this.allowedChunkClass(1)),
	          [h(
	            "a",
	            {
...
/***/ function(module, exports) {
	...
	module.exports = function () {
	  return {
	    vuex: {
	      actions: {
	        paginate: function paginate(store, page) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var clone = __webpack_require__(85);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(86).Buffer, __webpack_require__(19)(module)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var object_filled_keys_count = __webpack_require__(91);
	var is_valid_moment_object = __webpack_require__(39);
	var filterByCustomFilters = __webpack_require__(92);
	var clone = __webpack_require__(85);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var template = __webpack_require__(60);
	var VuePagination = __webpack_require__(76);
	var paginationBus = __webpack_require__(14);
	...
	exports.install = function (Vue, globalOptions) {
	  ...
	  var server = {
	    ...
	    methods: {
	      refresh: __webpack_require__(99),
	      getData: __webpack_require__(100),
	      setData: __webpack_require__(101),
	      serverSearch: __webpack_require__(28),
	      registerServerFilters: __webpack_require__(102),
	      initServerFilters: __webpack_require__(103)
	    },
	    computed: {
	      totalPages: __webpack_require__(83)
	    }
...
/***/ function(module, exports) {
	...
	module.exports = "<div><strong>{{ row.name }}</strong></div>\n";
